...
class Heatmap extends React.Component{
   ...
   render(){
      ...
      return ( 
               <svg width={this.props.width} height={this.props.height} id={this.props.divID}>
                  <defs>
                  ...
                  <Heatdata data={cellsData} transform={utility.tranSlate(this.props.width*0.20,this.props.height*0.10)} clipPathURL={'url(#'+this.props.divID+':#heatDataBox)'} zoomHandler={this.zoomHandler.bind(this)} zoomTransform={utility.tranSlate(0-x,0-y)+utility.tranScale(xRatio,yRatio)}/>
                  <Dendrogram key={0} data={colDendrogramData} transform={utility.tranSlate(this.props.width*0.20,0)} frame={colFrame} onClick={this.changeColNode} clipPathURL={'url(#'+this.props.divID+':#coldenBox)'} zoomTransform={utility.tranSlate(0-x,0)+utility.tranScale(xRatio,1)}/>
                  <Dendrogram key={1} data={rowDendrogramData} transform={utility.tranSlate(0,this.props.height*0.75)+'rotate(-90)'} frame={rowFrame} onClick={this.changeRowNode} clipPathURL={'url(#'+this.props.divID+':#rowdenBox)'}  zoomTransform={utility.tranSlate(0-((this.props.height*0.65*(yRatio-1))-y),0)+utility.tranScale(yRatio,1)}/>
               </svg>
              )
   }
